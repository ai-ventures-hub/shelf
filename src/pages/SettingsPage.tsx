...
import { SETTINGS_SECTIONS, settingsSection } from '../../shared/ui-navigation'
  ...
  return (
    <>
      ...
      <nav className="section-nav" aria-label="Settings sections">
        {SETTINGS_SECTIONS.filter((item) => isDeveloper || item.id !== 'advanced').map((item) => (
          <Link key={item.id} to={`/settings?section=${item.id}`} aria-current={section === item.id ? 'page' : undefined}>{item.label}</Link>
        ))}
      </nav>
      {section === 'general' && <div className="settings-group" aria-label="General settings">
        ...
        <section className="panel">
          <div className="panel-header">
            <h2 className="panel-title">Desktop behavior</h2>
          </div>
          <div className="panel-body stack">
      ...
      {section === 'appearance' && <div className="settings-group" aria-label="Appearance settings">
        <section className="panel">
          <div className="panel-header">
      ...
      {section === 'shortcuts' && <div className="settings-group" aria-label="Shortcuts settings">
        <section className="panel">
          <div className="panel-header">
            <h2 className="panel-title">Global shortcut</h2>
          </div>
          <div className="panel-body stack">
            <label className="checkbox-row">
              <input
        ...
        <section className="panel">
          ...
          <div className="panel-body">
            <ul className="shortcut-list">
              ...
              <li>
                <kbd>{prefs.globalShortcutEnabled ? prefs.globalShortcut : 'Disabled'}</kbd> Show / hide Shelf (global)
              </li>
              <li>
                <kbd>⌘N</kbd> Add tool
              </li>
      ...
      {section === 'updates' && <div className="settings-group" aria-label="Updates settings">
        <AppUpdatePanel />
        <section className="panel">
          <div className="panel-header">
      ...
      {section === 'advanced' && <div className="settings-group" aria-label="Advanced settings">
        <section className="panel">
          <div className="panel-header">

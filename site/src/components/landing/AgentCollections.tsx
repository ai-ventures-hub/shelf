...
/**
 * #collections — agent-built collections (1.3). Window left, copy right, so
 * it zigzags against #share above. Fully server-rendered: the collection page
...
export function AgentCollections() {
  return (
    <section id="collections" className="section" aria-labelledby="collections-heading">
      <div className="section-inner coll-grid">

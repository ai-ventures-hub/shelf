...
`shelf_record_capability_gap`, `shelf_list_capability_gaps`, `shelf_find_free_port`,
`shelf_inspect_project`, `shelf_upsert_tool`, `shelf_remove_tool`, `shelf_launch_tool`,
...
Resource: `shelf://tools/{id}/design-md`.

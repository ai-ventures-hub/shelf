...
export function buildGapBriefSections(
  ...
  sections.push({
    ...
    body: [
      ...
      '2. Ask Shelf to stage the finished tool. A new folder is NOT saved until the user accepts it:',
      '   `shelf_register_project` with the project\'s absolute folder path',
      '   Outcome `pending_consent` means it is waiting in Shelf. Do not launch it yourself.',
